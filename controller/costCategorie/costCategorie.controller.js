      ...
      if (err) {
        ...
        for (let index = 0; index < costs.length; index++) {
          tbody += `<tr>
                    ...
                    <td><a href="/costcategories/detail/${
                      costs[index].id
                    }" class="btn btn-primary">detail</a></td>
                    <td><a href="/costcategories/setcategories/${
                      costs[index].id
                    }" class="btn btn-primary">setting</a></td>
                    <td><a href="/costcategories/${
                      costs[index].id
                    }/delete" class="btn btn-danger" onclick="confirm('are you sure')">Delete</a></td>
                </tr>`;
        }
